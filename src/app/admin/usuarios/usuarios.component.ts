...
export class UsuariosComponent implements OnInit {
  ...
  getUsuariosAtivos() {
    this.sevUsuario.getUsuariosAtivos().subscribe((result) => {
      ...
      console.log(this.usuariosAtivos);
    });
  }
  ...
  editarCliente() {
    console.log();
    this.sevUsuario
      .PlanoCliente(this.idUsuario, this.formCliente.value)
      .subscribe(
        (res: any) => {
  ...
  confirmar() {
    this.sevUsuario.deletarCliente(this.idClienteDelete).subscribe((res) => {
      this.getUsuarios();
      this.getUsuariosInativos();
      this.getUsuariosAtivos();
  ...
  statusCliente(usuario) {
    if (usuario.active) {
      this.sevUsuario
        .statusCliente(usuario._id, { active: false })
        .subscribe((res: any) => {
          this.getUsuarios();
          this.getUsuariosInativos();
          this.getUsuariosAtivos();
    ...
    if (usuario.active == false) {
      this.sevUsuario
        .statusCliente(usuario._id, { active: true })
        .subscribe((res: any) => {
          this.getUsuarios();
          this.getUsuariosInativos();
          this.getUsuariosAtivos();
