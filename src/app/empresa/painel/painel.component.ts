...
export class PainelComponent implements OnInit {
  ...
  constructor(
    ...
    private sevProdutos: ProdutosService,
  ...
  atualizarProduto() {
    this.sevProdutos
      .editarProduto(this.data._id, this.formProdutosEdit.value)
      .subscribe((res: any) => {
        this.getProdutos();
  ...
  statusProduto(produto) {
    if (produto.active) {
      this.sevProdutos
        .statusProduto(produto._id, { active: false })
        .subscribe((res: any) => {
          this.getProdutos();
    ...
    if (produto.active == false) {
      this.sevProdutos
        .statusProduto(produto._id, { active: true })
        .subscribe((res: any) => {
          this.getProdutos();
  ...
  confirmar() {
    this.sevProdutos.deletarProduto(this.idProdutoDelete).subscribe((res) => {
      this.getProdutos();
  ...
  getProdutos() {
    ...
    this.sevProdutos
      .getProdutoCustomer(this.dadosUsuario.id)
      .subscribe((res) => {
        this.produtos = res;
